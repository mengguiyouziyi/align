...
parse.add_argument("-M", '--middleDir', dest='middleDir', default='/home/wande/文档/docx/middle', help="""中间文件所在的目录""")
parse.add_argument("-R", '--resultDir', dest='resultDir', default='/home/wande/文档/docx/result', help="""处理结果所在的目录""")
parse.add_argument("-s", '--srcFile', dest='srcFile', default='1.docx', help="""要处理的源文件""")
parse.add_argument("-t", '--tgtFile', dest='tgtFile', default='1-CN.docx', help="""要处理的目标文件""")
